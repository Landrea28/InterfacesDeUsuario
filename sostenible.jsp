...
<head>
  ...
  <title>Consumo Sostenible – FrescaTemporada</title>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .page-hero {
      background: linear-gradient(135deg, #d8f3dc 0%, #52b788 100%);
      padding: 3.5rem 2rem; text-align: center;
    }
    .page-hero .icono-grande { font-size: 4rem; margin-bottom: .5rem; }
    .page-hero h1 { font-size: 2.4rem; color: #1b4332; margin-bottom: .75rem; }
    .page-hero p { max-width: 650px; margin: 0 auto; font-size: 1.05rem; color: #1b4332; }
    ...
    /* CONSEJOS */
    .consejos { max-width: 1100px; margin: 0 auto 4rem; padding: 0 2rem; }
    .consejos h2 { font-size: 1.7rem; color: var(--verde-oscuro); margin-bottom: .4rem; }
    .consejos .sub { color: #666; margin-bottom: 2rem; }
    .consejos-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1.4rem; }
    .consejo-card {
      background: #fff; border-radius: var(--radio); padding: 1.8rem 1.5rem;
      box-shadow: var(--sombra); border-left: 5px solid var(--verde-medio);
    }
    .consejo-card .num { font-size: 2rem; font-weight: 900; color: var(--verde-claro); line-height: 1; margin-bottom: .4rem; }
    .consejo-card h3 { font-size: 1rem; color: var(--verde-oscuro); margin-bottom: .5rem; }
    .consejo-card p { font-size: .88rem; color: #666; }

    /* IMPACTO */
    .impacto { background: var(--verde-oscuro); padding: 4rem 2rem; color: #fff; }
    .impacto h2 { text-align: center; font-size: 1.7rem; margin-bottom: .4rem; }
    .impacto .sub { text-align: center; color: var(--verde-claro); margin-bottom: 2rem; }
    .stats-grid { max-width: 900px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; }
    .stat { background: rgba(255,255,255,.1); border-radius: var(--radio); padding: 1.5rem; text-align: center; }
    .stat .numero { font-size: 2.5rem; font-weight: 900; color: var(--verde-claro); }
    .stat p { font-size: .88rem; color: #cce5d6; margin-top: .3rem; }

    /* ACCIONES */
    .acciones { background: var(--gris-suave); padding: 4rem 2rem; }
    .acciones h2 { text-align: center; font-size: 1.7rem; color: var(--verde-oscuro); margin-bottom: 2rem; }
    .acc-grid { max-width: 1100px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.2rem; }
    .acc-card { background: #fff; border-radius: var(--radio); padding: 1.5rem; text-align: center; box-shadow: var(--sombra); }
    .acc-card .emoji { font-size: 2.4rem; margin-bottom: .5rem; }
    .acc-card h3 { font-size: .95rem; color: var(--verde-oscuro); margin-bottom: .3rem; }
    .acc-card p { font-size: .82rem; color: #666; }
    ...
    @media (max-width: 768px) {
      ...
      .consejos-grid { grid-template-columns: repeat(2, 1fr); }
      nav { display: none; }
...
<body>
    ...
    <div class="navbar">
      ...
      <nav>
        <ul>
          ...
          <li><a href="sostenible.html" class="active" title="Consumo Sostenible – Consejos para reducir el desperdicio y comprar local">Consumo Sostenible</a></li>
  ...
  <div class="nav-mobile" id="navMobile">
    ...
    <div class="nav-mobile-panel">
      ...
      <a href="sostenible.html" class="active" title="Consumo Sostenible – Consejos para un consumo responsable">♻️ Consumo Sostenible</a>
  ...
  <div class="page-hero">
    ...
    <p>
      Pequeñas decisiones de compra y consumo pueden generar un gran impacto en el
      medioambiente. Aprende a alimentarte bien sin comprometer el planeta.
    </p>
  </div>

  <div class="descripcion">
    <h2>¿Por qué es importante esta sección?</h2>
    <p>
      El sistema agroalimentario representa cerca del <strong>26% de las emisiones
      globales de CO₂</strong>. Elegir qué, dónde y cómo compramos los alimentos tiene
      consecuencias directas sobre el clima, el agua y la biodiversidad.
    </p>
    <p>
      En <strong>Consumo Sostenible</strong> encontrarás:
    </p>
    <ul>
      ...
      <li>Cómo el consumo de productos de temporada beneficia a los agricultores locales.</li>
      <li>Técnicas de conservación y aprovechamiento total del alimento (hojas, tallos, cáscaras).</li>
      <li>Indicadores del impacto ambiental de tus hábitos alimenticios y cómo mejorarlos.</li>
    </ul>
  </div>

  <!-- CONSEJOS PRÁCTICOS -->
  <div class="consejos">
    <h2>✅ 6 Consejos esenciales</h2>
    <p class="sub">Acciones concretas que puedes aplicar desde hoy mismo</p>
    <div class="consejos-grid">

      <div class="consejo-card">
        <div class="num">01</div>
        <h3>Compra lo que necesitas</h3>
        <p>Planifica tus comidas semanalmente antes de ir al mercado. Evita la compra impulsiva que lleva al desperdicio de alimentos.</p>
      </div>

      <div class="consejo-card">
        <div class="num">02</div>
        <h3>Elige productos locales</h3>
        <p>Los alimentos locales recorren menos kilómetros hasta tu mesa, reduciendo las emisiones de transporte y apoyando a productores cercanos.</p>
      </div>

      <div class="consejo-card">
        <div class="num">03</div>
        <h3>Consume la temporada</h3>
        <p>Las frutas y verduras fuera de temporada requieren invernaderos con alta energía o vuelos de carga internacional para llegar a ti.</p>
      </div>

      <div class="consejo-card">
        <div class="num">04</div>
        <h3>Aprovecha todo el alimento</h3>
        <p>Las hojas de zanahoria, los tallos de brócoli y las cáscaras de manzana son nutritivos. Úsalos en caldos, smoothies o compost.</p>
      </div>

      <div class="consejo-card">
        <div class="num">05</div>
        <h3>Almacena correctamente</h3>
        <p>Conoce qué va en la nevera y qué no. Un mal almacenamiento es la primera causa de desperdicio doméstico de frutas y verduras.</p>
      </div>

      <div class="consejo-card">
        <div class="num">06</div>
        <h3>Prefiere envase mínimo</h3>
        <p>Compra a granel cuando sea posible. El exceso de envases plásticos en frutas y verduras genera millones de toneladas de residuos anuales.</p>
      </div>
  ...
  <section class="impacto">
    <h2>🌍 El impacto en números</h2>
    <p class="sub">Lo que genera nuestro sistema alimentario actual</p>
    <div class="stats-grid">
      <div class="stat">
        <div class="numero">1/3</div>
        <p>De todos los alimentos producidos en el mundo se desperdicia cada año</p>
      </div>
      <div class="stat">
        <div class="numero">8%</div>
        <p>De las emisiones globales provienen del desperdicio de alimentos</p>
      </div>
      <div class="stat">
        <div class="numero">50%</div>
        <p>Menos emisiones genera consumir productos de temporada vs. importados</p>
      </div>
      <div class="stat">
        <div class="numero">70%</div>
        <p>Del agua dulce mundial se usa en agricultura</p>
      </div>
    </div>
  </section>
  ...
  <section class="acciones">
    <h2>🛒 Cómo actuar en el día a día</h2>
    <div class="acc-grid">
      <div class="acc-card"><div class="emoji">🧺</div><h3>Mercados de barrio</h3><p>Prioriza tiendas locales y mercados de productores frente a supermercados con producto de importación.</p></div>
      ...
      <div class="acc-card"><div class="emoji">🌱</div><h3>Huerto en casa</h3><p>Incluso una maceta de hierbas aromáticas o tomates cherry reduce tu huella y te conecta con el alimento.</p></div>
      <div class="acc-card"><div class="emoji">🚲</div><h3>Compra de proximidad</h3><p>Desplázate andando o en bici al mercado cuando sea posible. Cada trayecto en coche suma emisiones.</p></div>
